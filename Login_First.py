...
class MainWindow(QMainWindow):
    ...
    def loadFinishedHandler(self):
        ...
        '''if self.bMain:
            ...
            self.bReloadFirst = False
            self.bLoginFirst = True'''
        if not self.bReloadFirst and self.bLoginFirst:
            print('main run')
        ...
        '''if self.bMain:
            print('get_set_up')
            #self.get_set_up()
            self.brequestF5 = True
            self.bMain = False
            self.bLoginFirst = True
        elif not self.bMain and not self.brequestF5 and self.bLoginFirst:
            print('navigate_login first')
            self.navigate_login_First()
            self.bMain = False
            self.bLoginFirst = False
            self.bLogin = True
            self.bEnter = True
        elif not self.bLoginFirst and self.bLogin and not self.bEnter:
            print('change password')
            self.changePassword()
            self.bLogin = False
            self.bPasswordChange = True
        elif not self.bLogin and self.bPasswordChange:
            print('navigate_login')
            self.navigate_login()
            self.bPasswordChange = False
            self.bGo2GChange = True
            ...
            self.b2GChange = False
            self.bGo5GChange = True
        elif not self.b2GChange and self.bGo5GChange:
            self.Go5GHzSecurity()            
            self.bGo5GChange = False
            self.b5GChange = True            
